...
def main():
    ...
    # 페르소나 카드
    persona_list = [
        {"이름": "김륜영 연구원", "연구소": "통장연구소", "설명": "당신의 통장, 과연 퇴사를 허락할까? 텅장랩은 월 생활비, 대출 상환액, 현재 자산을 분석해 퇴사 가능성을 객관적으로 진단해준다. 퇴사는 감정이 아니라 현실이다 텅장랩과 함께 현실적인 선택을 하길 바란다", "이모지": "💰"},
        {"이름": "안지원 연구원", "연구소": "팩트폭격연구실", "설명": "감정 위로는 없다. 오직 냉철한 데이터와 현실만 있을 뿐. 팩트폭격랩은 당신의 이력을 철저히 분석하고, 현재 채용시장의 실태와 비교해 이직 성공 확률을 계산한다. '니가 사표 던지기 전에, 최소한 현실은 보고 가라.' 지금 퇴사하면 백수 될 확률부터 최적의 퇴사 타이밍까지, 모든 현실을 직설적으로 알려준다. 감성적인 위로보다 냉정한 현실 체크가 필요하면, 팩트폭격랩의 문을 두드려라.", "이모지": "💣"},
        {"이름": "최석호 연구원", "연구소": "직무 분석 연구소", "설명": "다양한 직무에 대한 채용 공고 수를 분석하여, 각 직무가 시장에서 얼마나 많이 요구되는지 파악하자.", "이모지": "🔍"},
        {"이름": "하상우 연구원", "연구소": "쇼생크 랩스", "설명": "탈옥처럼 체계적이고 치밀한 퇴사/이직 준비! 이제 쇼생크 랩에서 여러분의 성공적인 탈옥(퇴사/이직)을 준비해보세요!", "이모지": "🕊️"},
        {"이름": "전나영 연구원", "연구소": "떠남점검 연구소", "설명": "인사담당자 시절, 퇴사하려는 직원들을 붙잡는 게 일이었다. 그 경험 덕분에, 퇴사를 결심하는 심리를 연구하게 됐다. 퇴사가 정말 최선인가 혹은 퇴사를 하는 게 맞나 싶다면, 이 연구원이 대답해줄 수 있다.", "이모지": "🧳"},
    ]
