...
def show_header():
    st.markdown(
        ...
        <div class="header-container">
            <div class="header">
                💰 텅장랩 - 재정 진단 & 고금리 금융상품 추천기
            </div>
            <div class="subheader">
                당신의 통장, 퇴사를 허락할까?<br>현실적인 재정 판단과 추천을 동시에 제공합니다.
            </div>
        </div>
        """,
...
def main():
    ...
    st.markdown(
        ...
        <div class="input-section">
            <div class="section-title">1️⃣ 재정 상태 입력</div>
        </div>
        """,
        unsafe_allow_html=True
    )
    ...
    if st.button("퇴사 가능성 진단하기"):
        with st.spinner("🔍 재정 상황 분석 중..."):
            ...
            st.markdown(
                ...
                <div class="result-section">
                    <div class="section-title">2️⃣ 진단 결과</div>
                </div>
                """,
                unsafe_allow_html=True
            )
            ...
            if current_savings >= needed_money:
                ...
                st.markdown(
                    ...
                    <div class="recommendation-section">
                        <div class="recommendation-title">💰 부족한 당신을 위한 실시간 고금리 예적금 상품 추천</div>
                    </div>
                    """,
                    unsafe_allow_html=True
                )
        ...
        st.markdown(
            ...
            <div class="tips-section">
                <div class="tips-title">💡 생활비 절약 실시간 꿀팁</div>
            </div>
            """,
            unsafe_allow_html=True
        )
        ...
        st.markdown(
            ...
            <div class="shopping-section">
                <div class="shopping-title">🛒 알뜰 쇼핑몰 추천</div>
            </div>
            """,
            unsafe_allow_html=True
        )
